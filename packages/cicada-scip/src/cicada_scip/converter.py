...
def _get_python_symbols():
    ...
    if _python_symbols is None:
        try:
            import cicada_scip.languages.python.symbol_types as ps

            _python_symbols = ps
        except ImportError:
            # Fallback to main cicada package if available
            try:
...
def _get_typescript_symbols():
    ...
    if _typescript_symbols is None:
        try:
            import cicada_scip.languages.typescript.symbol_types as ts
